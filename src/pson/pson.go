...
func (e *Printer) emit(s string) (err error) {
	t := Tokenize(s)
	err = e.emitToken(t); if err != nil { return err }
	return nil
}
...
func (e *Printer) emitToken(t string) (err error) {
	...
	_, err = e.out.Write([]byte(t)); if err != nil { return err }
	e.ntoken++;
	return nil
}
...
func (e *Printer) Print(s string, args ...string) (err error) {
	...
	err = e.emit(s); if err != nil { return err }
	for _, a := range args {
		err = e.emit(a); if err != nil { return err }
	}
	return nil
}

func (e *Printer) PrintIndent(s string, args ...string) (err error) {
	err = e.Print(s, args...); if err != nil { return err }
	err = e.Indent(); if err != nil { return err }
	return nil
}

func (e *Printer) Indent() (err error) {
	err = e.emitToken("{"); if err != nil { return err }
	err = e.EndLine(); if err != nil { return err }
	e.indent++
	return nil
}
